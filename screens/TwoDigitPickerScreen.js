...
const TwoDigitPickerScreen = () => {
  const [lotteryNumber, setLotteryNumber] = useState('00');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>2-Digit Lottery</Text>
...
export default TwoDigitPickerScreen; 